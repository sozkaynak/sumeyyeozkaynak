# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-07-07 21:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blog.Category', verbose_name='Kategori Adı')),
            ],
        ),
        migrations.AddField(
            model_name='post',
